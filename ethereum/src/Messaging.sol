...
contract Messaging {
     ...
     */
    function sendMessageValue(uint256 contractAddress, uint256 selector, uint256 value) external payable {
     ...
     */
    function consumeMessageStruct(uint256 fromAddress, uint256[] calldata payload) external {
        _snMessaging.consumeMessageFromL2(fromAddress, payload);
